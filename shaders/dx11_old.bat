...
shadercRelease.exe -f .\src\terrain\terrain_vs.sc -o .\dx11\vertex\terrain_vs.bin --varyingdef .\src\terrain\varying.def.sc -i ..\..\bgfx\src\ -i .\src --type vertex --platform windows -p vs_4_0
shadercRelease.exe -f .\src\terrain\terrain_fs.sc -o .\dx11\fragment\terrain_fs.bin --varyingdef .\src\terrain\varying.def.sc -i ..\..\bgfx\src\ -i .\src --type fragment --platform windows -p ps_5_0