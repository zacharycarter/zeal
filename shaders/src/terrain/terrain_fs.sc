$input v_texcoord0, v_materialID, v_wpos, v_normal, v_blendMode, v_adjacentMatIndices
...
SAMPLER2DARRAY(tex_array0, 0);


vec4 texture_val(int mat_idx, vec2 uv)
{
    return textureGather(tex_array0, vec3(uv, mat_idx));
}
