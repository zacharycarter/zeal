...
uniform SamplerState u_SplatMapSamplerSampler : register(s[9]); uniform Texture2D u_SplatMapSamplerTexture : register(t[9]); static BgfxSampler2D u_SplatMapSampler = { u_SplatMapSamplerSampler, u_SplatMapSamplerTexture };
uniform SamplerState u_GrassSamplerSampler : register(s[10]); uniform Texture2D u_GrassSamplerTexture : register(t[10]); static BgfxSampler2D u_GrassSampler = { u_GrassSamplerSampler, u_GrassSamplerTexture };
uniform SamplerState u_CliffsSamplerSampler : register(s[11]); uniform Texture2D u_CliffsSamplerTexture : register(t[11]); static BgfxSampler2D u_CliffsSampler = { u_CliffsSamplerSampler, u_CliffsSamplerTexture };
uniform SamplerState u_SnowyGrassSamplerSampler : register(s[12]); uniform Texture2D u_SnowyGrassSamplerTexture : register(t[12]); static BgfxSampler2D u_SnowyGrassSampler = { u_SnowyGrassSamplerSampler, u_SnowyGrassSamplerTexture };
...
float4 alpha = bgfxTexture2D(u_SplatMapSampler, v_texcoord0.xy );
float4 tex0 = bgfxTexture2D(u_SnowyGrassSampler, v_texcoord0.xy * 8.0 );
float4 tex1 = bgfxTexture2D(u_CliffsSampler, v_texcoord0.xy * 8.0 );
float4 tex2 = bgfxTexture2D(u_GrassSampler, v_texcoord0.xy * 8.0 );
tex0 *= alpha.r;
tex1 = mix( tex0, tex1, alpha.g );
float4 outColor = mix( tex1, tex2, alpha.b );
