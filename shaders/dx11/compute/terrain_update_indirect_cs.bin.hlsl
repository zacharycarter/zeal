...
uint cnt = (counter / 2u) / 32u + 1u;
uint tmp;
InterlockedExchange(atomicCounterBuffer[2], (counter / 2), tmp);
indirectBuffer[1u*2+0] = uint4(cnt, 1u, 1u, 0u);
}
