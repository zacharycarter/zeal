...
proc nk_slide_int*(a1: ptr nk_context; min: cint; val: cint; max: cint; step: cint): cint {.
    cdecl, importc.}
proc nk_slider_float*(a1: ptr nk_context; min: cfloat; val: pointer; max: cfloat;
                     step: cfloat): cint {.cdecl, importc.}
proc nk_slider_int*(a1: ptr nk_context; min: cint; val: pointer; max: cint; step: cint): cint {.
    cdecl, importc.}
proc nk_progress*(a1: ptr nk_context; cur: pointer; max: nk_size; modifyable: cint): cint {.
    cdecl, importc.}
...
proc nk_color_pick*(a1: ptr nk_context; a2: ptr nk_colorf; a3: nk_color_format): cint {.
    cdecl, importc.}
proc nk_property_int*(a1: ptr nk_context; name: cstring; min: cint; val: pointer;
                     max: cint; step: cint; inc_per_pixel: cfloat) {.cdecl,
    importc.}
proc nk_property_float*(a1: ptr nk_context; name: cstring; min: cfloat; val: pointer;
                       max: cfloat; step: cfloat; inc_per_pixel: cfloat) {.cdecl,
    importc.}
proc nk_property_double*(a1: ptr nk_context; name: cstring; min: cdouble;
                        val: pointer; max: cdouble; step: cdouble;
...
proc nk_propertyd*(a1: ptr nk_context; name: cstring; min: cdouble; val: cdouble;
    ...
    importc.}
proc nk_edit_string*(a1: ptr nk_context; a2: nk_flags; buffer: cstring; len: pointer;
...
proc nk_plot*(a1: ptr nk_context; a2: nk_chart_type; values: pointer; count: cint;
...
proc nk_popup_get_scroll*(a1: ptr nk_context; offset_x: pointer;
                         offset_y: pointer) {.cdecl,
    importc.}
...
proc nk_combobox*(a1: ptr nk_context; items: cstringArray; count: cint;
                 selected: pointer; item_height: cint; size: nk_vec2) {.cdecl,
    importc.}
proc nk_combobox_string*(a1: ptr nk_context; items_separated_by_zeros: cstring;
                        selected: pointer; count: cint; item_height: cint;
...
proc nk_combobox_callback*(a1: ptr nk_context; item_getter: proc (a1: pointer; a2: cint;
    a3: cstringArray) {.cdecl.}; a3: pointer; selected: pointer; count: cint;
...
proc nk_style_push_font*(a1: ptr nk_context; a2: ptr nk_user_font): cint {.cdecl,
    importc.}
proc nk_style_push_float*(a1: ptr nk_context; a2: pointer; a3: cfloat): cint {.cdecl,
    importc.}
...
proc nk_style_push_style_item*(a1: ptr nk_context; a2: ptr nk_style_item;
    ...
    importc.}
proc nk_style_push_flags*(a1: ptr nk_context; a2: pointer; a3: nk_flags): cint {.
    cdecl, importc.}
...
proc nk_rgb_iv*(rgb: pointer): nk_color {.cdecl, importc.}
proc nk_rgb_bv*(rgb: pointer): nk_color {.cdecl, importc.}
proc nk_rgb_f*(r: cfloat; g: cfloat; b: cfloat): nk_color {.cdecl,
    importc.}
proc nk_rgb_fv*(rgb: pointer): nk_color {.cdecl, importc.}
...
proc nk_rgba_iv*(rgba: pointer): nk_color {.cdecl, importc.}
proc nk_rgba_bv*(rgba: pointer): nk_color {.cdecl, importc.}
proc nk_rgba_f*(r: cfloat; g: cfloat; b: cfloat; a: cfloat): nk_color {.cdecl,
    importc.}
proc nk_rgba_fv*(rgba: pointer): nk_color {.cdecl, importc.}
...
proc nk_hsva_colorf*(h: cfloat; s: cfloat; v: cfloat; a: cfloat): nk_colorf {.cdecl,
    importc.}
proc nk_hsva_colorfv*(c: pointer): nk_colorf {.cdecl,
    importc.}
proc nk_colorf_hsva_f*(out_h: pointer; out_s: pointer; out_v: pointer;
                      out_a: pointer; `in`: nk_colorf) {.cdecl,
    importc.}
proc nk_colorf_hsva_fv*(hsva: pointer; `in`: nk_colorf) {.cdecl,
    importc.}
proc nk_hsv*(h: cint; s: cint; v: cint): nk_color {.cdecl, importc.}
proc nk_hsv_iv*(hsv: pointer): nk_color {.cdecl, importc.}
proc nk_hsv_bv*(hsv: pointer): nk_color {.cdecl, importc.}
proc nk_hsv_f*(h: cfloat; s: cfloat; v: cfloat): nk_color {.cdecl,
    importc.}
proc nk_hsv_fv*(hsv: pointer): nk_color {.cdecl, importc.}
proc nk_hsva*(h: cint; s: cint; v: cint; a: cint): nk_color {.cdecl,
    importc.}
proc nk_hsva_iv*(hsva: pointer): nk_color {.cdecl, importc.}
proc nk_hsva_bv*(hsva: pointer): nk_color {.cdecl, importc.}
proc nk_hsva_f*(h: cfloat; s: cfloat; v: cfloat; a: cfloat): nk_color {.cdecl,
    importc.}
proc nk_hsva_fv*(hsva: pointer): nk_color {.cdecl, importc.}
proc new_nk_color_f*(r: pointer; g: pointer; b: pointer; a: pointer; a5: nk_color) {.
    cdecl, importc: "nk_color_f".}
proc nk_color_fv*(rgba_out: pointer; a2: nk_color) {.cdecl,
    importc.}
proc nk_color_cf*(a1: nk_color): nk_colorf {.cdecl, importc.}
proc nk_color_d*(r: pointer; g: pointer; b: pointer; a: pointer; a5: nk_color) {.
    cdecl, importc.}
proc nk_color_dv*(rgba_out: pointer; a2: nk_color) {.cdecl,
    importc.}
...
proc nk_color_hex_rgb*(output: cstring; a2: nk_color) {.cdecl,
    importc.}
proc nk_color_hsv_i*(out_h: pointer; out_s: pointer; out_v: pointer; a4: nk_color) {.
    cdecl, importc.}
proc nk_color_hsv_b*(out_h: pointer; out_s: pointer; out_v: pointer;
                    a4: nk_color) {.cdecl, importc.}
proc nk_color_hsv_iv*(hsv_out: pointer; a2: nk_color) {.cdecl,
    importc.}
proc nk_color_hsv_bv*(hsv_out: pointer; a2: nk_color) {.cdecl,
    importc.}
proc nk_color_hsv_f*(out_h: pointer; out_s: pointer; out_v: pointer; a4: nk_color) {.
    cdecl, importc.}
proc nk_color_hsv_fv*(hsv_out: pointer; a2: nk_color) {.cdecl,
    importc.}
proc nk_color_hsva_i*(h: pointer; s: pointer; v: pointer; a: pointer; a5: nk_color) {.
    cdecl, importc.}
proc nk_color_hsva_b*(h: pointer; s: pointer; v: pointer; a: pointer;
                     a5: nk_color) {.cdecl, importc.}
proc nk_color_hsva_iv*(hsva_out: pointer; a2: nk_color) {.cdecl,
    importc.}
proc nk_color_hsva_bv*(hsva_out: pointer; a2: nk_color) {.cdecl,
    importc.}
proc nk_color_hsva_f*(out_h: pointer; out_s: pointer; out_v: pointer;
                     out_a: pointer; a5: nk_color) {.cdecl,
    importc.}
proc nk_color_hsva_fv*(hsva_out: pointer; a2: nk_color) {.cdecl,
    importc.}
...
proc nk_vec2v*(xy: pointer): nk_vec2 {.cdecl, importc.}
proc nk_vec2iv*(xy: pointer): nk_vec2 {.cdecl, importc.}
...
proc nk_rectv*(xywh: pointer): nk_rect {.cdecl, importc.}
proc nk_rectiv*(xywh: pointer): nk_rect {.cdecl, importc.}
...
proc nk_strfilter*(text: cstring; regexp: cstring): cint {.cdecl,
    importc.}
proc nk_strmatch_fuzzy_string*(str: cstring; pattern: cstring; out_score: pointer): cint {.
    cdecl, importc.}
proc nk_strmatch_fuzzy_text*(txt: cstring; txt_len: cint; pattern: cstring;
                            out_score: pointer): cint {.cdecl,
    importc.}
proc nk_utf_decode*(a1: cstring; a2: pointer; a3: cint): cint {.cdecl,
    importc.}
proc nk_utf_encode*(a1: nk_rune; a2: cstring; a3: cint): cint {.cdecl,
    importc.}
proc nk_utf_len*(a1: cstring; byte_len: cint): cint {.cdecl,
    importc.}
proc nk_utf_at*(buffer: cstring; length: cint; index: cint; unicode: pointer;
               len: pointer): cstring {.cdecl, importc.}
proc nk_font_default_glyph_ranges*(): pointer {.cdecl,
    importc.}
proc nk_font_chinese_glyph_ranges*(): pointer {.cdecl,
    importc.}
proc nk_font_cyrillic_glyph_ranges*(): pointer {.cdecl,
    importc.}
proc nk_font_korean_glyph_ranges*(): pointer {.cdecl,
    importc.}
...
proc nk_font_atlas_add_compressed_base85*(a1: ptr nk_font_atlas; data: cstring;
    ...
    importc.}
proc nk_font_atlas_bake*(a1: ptr nk_font_atlas; width: pointer; height: pointer;
...
proc nk_str_append_str_utf8*(a1: ptr nk_str; a2: cstring): cint {.cdecl,
    importc.}
proc nk_str_append_text_runes*(a1: ptr nk_str; a2: pointer; a3: cint): cint {.cdecl,
    importc.}
proc nk_str_append_str_runes*(a1: ptr nk_str; a2: pointer): cint {.cdecl,
    importc.}
...
proc nk_str_insert_str_utf8*(a1: ptr nk_str; pos: cint; a3: cstring): cint {.cdecl,
    importc.}
proc nk_str_insert_text_runes*(a1: ptr nk_str; pos: cint; a3: pointer; a4: cint): cint {.
    cdecl, importc.}
proc nk_str_insert_str_runes*(a1: ptr nk_str; pos: cint; a3: pointer): cint {.cdecl,
    importc.}
...
proc nk_str_at_char*(a1: ptr nk_str; pos: cint): cstring {.cdecl,
    importc.}
proc nk_str_at_rune*(a1: ptr nk_str; pos: cint; unicode: pointer; len: pointer): cstring {.
    cdecl, importc.}
proc nk_str_rune_at*(a1: ptr nk_str; pos: cint): nk_rune {.cdecl,
    importc.}
proc nk_str_at_char_const*(a1: ptr nk_str; pos: cint): cstring {.cdecl,
    importc.}
proc nk_str_at_const*(a1: ptr nk_str; pos: cint; unicode: pointer; len: pointer): cstring {.
    cdecl, importc.}
...
proc nk_stroke_polyline*(a1: ptr nk_command_buffer; points: pointer;
                        point_count: cint; line_thickness: cfloat; col: nk_color) {.
    cdecl, importc.}
proc nk_stroke_polygon*(a1: ptr nk_command_buffer; a2: pointer; point_count: cint;
                       line_thickness: cfloat; a5: nk_color) {.cdecl,
    importc.}
...
proc nk_fill_triangle*(a1: ptr nk_command_buffer; x0: cfloat; y0: cfloat; x1: cfloat;
    ...
    importc.}
proc nk_fill_polygon*(a1: ptr nk_command_buffer; a2: pointer; point_count: cint;
                     a4: nk_color) {.cdecl, importc.}
